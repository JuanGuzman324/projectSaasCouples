  ...
  .init({
    resources: {
      ...
      fr: {
        ...
        yearreview: frYearreview,
      },
    },
    supportedLngs: SUPPORTED_LANGS as unknown as string[],
    fallbackLng: 'es',
    ns: ['common', 'auth', 'couple', 'home', 'memories', 'dates', 'moments', 'timecapsules', 'yearreview'],
    defaultNS: 'common',
